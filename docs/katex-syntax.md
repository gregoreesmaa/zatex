...
Mirror of the KaTeX supported-syntax table with a render of every accepted function. Generated by `tools/gen_doc_renders.py` — do not edit.
...
| `\` | `\begin{matrix}a\\b\end{matrix}` | ![](renders/break.png) |  |
| `\"` | `\"o` | ![](renders/quot.png) |  |
| `\$` | `\$` | ![](renders/dollar.png) |  |
...
| `\}` | `\{x\}` | ![](renders/fn-5.png) |  |
| `\|` | `\\|x\\|` | ![](renders/pipe.png) |  |
| `\\|` | `\begin{matrix}a\\\|b\end{matrix}` | ![](renders/pipe-2.png) |  |
| `\~` | `\~n` | ![](renders/tilde.png) |  |
| `^` | `x^2` | ![](renders/pow.png) |  |
| `\^` | `\^{x}` | ![](renders/pow-2.png) |  |
...
| `\dArr` | — | — | owner #1 |
| `\darr` | — | — | owner #1 |
| `{darray}` | `\begin{darray}{c}a\\b\end{darray}` | *no render (engine)* | displaystyle array missing; KaTeX accepts |
