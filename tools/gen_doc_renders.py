...
EXACT = {
    ...
    "\\mathsfit": ("\\mathsfit{AaBb}", False),
    "\\bgroup": ("\\bgroup x}", False),
    "\\egroup": ("x{a\\egroup", False),
    "\\textcopyright": ("\\textcopyright", False),
    "\\@firstoftwo": ("\\@firstoftwo{a}{b}", False),
    "\\@secondoftwo": ("\\@secondoftwo{a}{b}", False),
    "\\@ifnextchar": ("\\@ifnextchar{a}{T}{E}a", False),
    "\\@ifstar": ("\\@ifstar{T}{E}*", False),
    "\\TextOrMath": ("\\TextOrMath{a}{b}", False),
